sap.ui.define([
    ...
    return Controller.extend("frontend.bbs.controller.userAdministration.Role", {
       onInit: function () {
		var oModel = new JSONModel(sap.ui.require.toUrl("frontend/bbs/model/users.json"));
		this.getView().setModel(oModel);
		this.getOwnerComponent().getModel("navigationList").setProperty('/selectedKey', "userAdministrationUser");
