					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BBS SAP Add On Dashboard",
									"targetURL": "#frontendbbs-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"frontendbbs-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=frontend.bbs",
									"url": sap.ui.require.toUrl("frontend/bbs")
								}
							}
						}
					}
